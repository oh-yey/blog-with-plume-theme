...
const gitDoc = defineCollection({
    // doc 类型，该类型带有侧边栏
    type: 'doc',
    // 文档集合所在目录，相对于 `docs`
    dir: 'markdown/notes/git/',
...
const protoDoc = defineCollection({
    type: 'doc',
    dir: 'markdown/notes/proto/',
    linkPrefix: '/proto',
    title: 'proto',
    sidebar: 'auto',
})

const goDoc = defineCollection({
    type: 'doc',
    dir: 'markdown/notes/go/',
    linkPrefix: '/go',
    title: 'go',
    sidebar: 'auto',
})
...
const esDoc = defineCollection({
    type: 'doc',
    dir: 'markdown/notes/es/',
    linkPrefix: '/es',
    title: 'es',
    sidebar: 'auto',
})

const algorithmDoc = defineCollection({
    type: 'doc',
    dir: 'markdown/notes/算法/',
